...
export class AppComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AppComponent, selectors: [["app-root"]], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [RouterOutlet], styles: ["[_nghost-%COMP%] { display: block; height: 100%; }"] }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AppComponent, [{
        type: Component,
        args: [{ selector: 'app-root', standalone: true, imports: [RouterOutlet], template: `<router-outlet></router-outlet>`, styles: ["\n    :host { display: block; height: 100%; }\n  "] }]
    }], null, null); })();
