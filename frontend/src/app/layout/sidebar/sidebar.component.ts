    ...
    <aside class="sidebar" [class.collapsed]="collapsed">
      ...
      <div class="sidebar-logo">
        <a routerLink="/dashboard" class="logo-link">
          ...
          <span class="logo-text" *ngIf="!collapsed">inter<strong>V</strong></span>
        </a>
        <button class="collapse-btn" (click)="toggleSidebar.emit()" title="Toggle sidebar">
          <span>{{ collapsed ? '→' : '←' }}</span>
        </button>
      </div>
      ...
      <div class="sidebar-user" *ngIf="!collapsed">
        <a routerLink="/profile" class="user-link">
          <div class="avatar-placeholder avatar-sm" style="font-size:0.75rem;">{{ user.initials }}</div>
          <div class="user-info">
            <div class="user-name">{{ user.name }}</div>
            <div class="user-plan">
              <span class="chip chip-teal" style="font-size:0.6rem; padding:2px 6px;">{{ user.plan | titlecase }}</span>
            </div>
          </div>
        </a>
      </div>
