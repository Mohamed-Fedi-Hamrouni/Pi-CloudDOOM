                        ...
                        >
                            <div class="pp-grid">
                                <div class="pp-stat">
                                    ...
                                    <div class="action-buttons" style="margin-top:var(--space-3);">
                                        <button
                                            *ngIf="selectedInterviewUser?.status === 'ACTIVE'"
                                            class="action-btn action-btn-orange"
                                            (click)="updateStatus(selectedInterviewUser!, 'SUSPENDED')"
                                        >
                                            Suspend
                                        </button>
                                        <button
                                            *ngIf="selectedInterviewUser?.status === 'SUSPENDED'"
                                            class="action-btn action-btn-green"
                                            (click)="updateStatus(selectedInterviewUser!, 'ACTIVE')"
                                        >
                                            Activate
                                        </button>
                                        <button
                                            class="action-btn action-btn-red"
                                            (click)="deleteUser(selectedInterviewUser!)"
                                        >
                                            🗑
                                        </button>
                                        <button
                                            *ngIf="selectedInterviewUser?.status === 'DELETED'"
                                            class="action-btn action-btn-green"
                                            (click)="restoreUser(selectedInterviewUser!)"
                                        >
                                            ↩ Restore
                                        </button>
                                    </div>
