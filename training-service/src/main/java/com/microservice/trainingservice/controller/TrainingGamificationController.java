...
public class TrainingGamificationController {
    ...
    /*@GetMapping("/modules")
    public List<TrainingModuleResponse> getAllPublicModules() {
        return trainingGamificationService.getAllModules();
    }*/
    @GetMapping("/modules")
    public List<TrainingModuleResponse> getMyModules(Authentication authentication) {
        if (authentication == null || authentication.getName() == null) {
            throw new AccessDeniedException("Authentication required");
        }
        // On appelle la nouvelle méthode du service avec l'ID du user connecté
        return trainingGamificationService.getAllModulesForUser(authentication.getName());
    }
